    ...
    <>
      <BreadcrumbStructuredData
        items={[
          ...
          { name: "Press", item: "https://evolutionstables.nz/press" },
        ]}
      />
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <header className="mb-20 max-w-3xl">
            ...
            <p className="text-xl text-white/60 font-light leading-relaxed">
              Stay updated with our latest announcements and media features as
              we bridge the gap between traditional equine excellence and modern
              digital syndication.
            </p>
          </header>
