...
export const metadata: Metadata = {
  ...
  description: 'The latest news, media coverage, and press releases from Evolution Stables. Discover how we are transforming thoroughbred ownership through digital innovation.',
  alternates: {
    canonical: '/press',
  },
};
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        <header className="mb-20 max-w-3xl">
          <div className="flex items-center gap-4 mb-6">
            <span className="text-[10px] uppercase tracking-[0.4em] text-[#d4af37] font-semibold">Media Relations</span>
