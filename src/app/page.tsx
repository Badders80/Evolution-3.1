    ...
    <div className="min-h-screen">
      <main className="text-foreground">
        <h1 className="sr-only">
          Evolution Stables - Digital Racehorse Ownership & Tokenized RWA
          Platform
        </h1>
          ...
          <div className="max-w-6xl mx-auto px-12 md:px-16 lg:px-20 w-full">
            ...
            <div className="space-y-12 mb-16">
              ...
              <p className="text-[16px] leading-[1.7] font-light text-white/65">
                At Evolution Stables, we understand that ownership is the
                lifeblood of racing — and strengthening it benefits every part
                of the industry.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Card 1 */}
              <div className="group relative bg-white/[0.02] border border-white/[0.08] rounded-lg p-10 transition-all duration-700 ease-out hover:bg-white/[0.04] hover:border-white/[0.15] hover:shadow-[0_8px_30px_rgba(0,0,0,0.4)] cursor-pointer">
                <div
                ...
                <div className="relative space-y-4">
                  ...
                  <p className="text-[15px] leading-[1.9] font-light text-white/60">
                    Ownership, on your terms. Simplified terms and conditions
                    give you the full thrill of ownership in a transparent,
                    regulated marketplace — where risk and return are clear
                    before you buy.
                  </p>
                </div>
              </div>
              ...
              <div className="group relative bg-white/[0.02] border border-white/[0.08] rounded-lg p-10 transition-all duration-700 ease-out hover:bg-white/[0.04] hover:border-white/[0.15] hover:shadow-[0_8px_30px_rgba(0,0,0,0.4)] cursor-pointer">
                ...
                <div className="relative space-y-4">
                  ...
                  <p className="text-[15px] leading-[1.9] font-light text-white/60">
                    Expand your reach and retain full control, with offers
                    structured, managed, and delivered — all in one place.
                  </p>
                </div>
              </div>
              ...
              <div className="group relative bg-white/[0.02] border border-white/[0.08] rounded-lg p-10 transition-all duration-700 ease-out hover:bg-white/[0.04] hover:border-white/[0.15] hover:shadow-[0_8px_30px_rgba(0,0,0,0.4)] cursor-pointer">
                ...
                <div className="relative space-y-4">
                  ...
                  <p className="text-[15px] leading-[1.9] font-light text-white/60">
                    Ownership is the gateway to deeper engagement — turning
                    one-time spectators into lifelong members, building revenue,
                    and strengthening the sport&apos;s future, all in one place.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section
          ...
          className="py-56 bg-background text-foreground"
        >
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="grid gap-16 lg:grid-cols-[1fr,1fr] lg:gap-48 xl:gap-56">
              ...
              <div className="space-y-8">
                ...
                {/* Lead Paragraph */}
                <p className="text-[16px] leading-[1.7] font-light text-white/65">
                  Syndication has always been the heartbeat of racehorse
                  ownership — sharing risk, reward, and the thrill of the sport.
                  But the way people participate has changed.
                </p>
                <p className="text-[16px] leading-[1.7] font-light text-white/65">
          ...
          <div className="max-w-6xl mx-auto px-12 md:px-16 lg:px-20">
            ...
            <div className="mb-24 space-y-6">
              ...
              <p className="text-[18px] leading-[1.7] font-light text-white/80 max-w-3xl">
                Great news for Evolution Stables investors — Prudentia has
                scored a tough, gutsy victory in Race 7 (BM65, 1300m) at Te Rapa
                this afternoon on a Heavy 10 track.
              </p>
              <p className="text-[16px] leading-[1.7] font-light text-white/50 max-w-3xl">
                She showed her class, coming from deep in the field at the
                halfway mark, running the perfect race to take the lead where it
                counted and fighting hard all the way to the line under Masa
                Hashizume.
              </p>
              <div className="pt-4">
                <a
                  ...
                  <div className="space-y-12">
                    ...
                    <div className="space-y-4">
                      ...
                      <p className="text-[15px] leading-[1.7] font-light text-white/50 transition-colors duration-500 group-hover:text-white/80">
                        Explore available syndications and short-term leases —
                        all clearly structured, fully transparent, and ready to
                ...
                <div className="group flex flex-col gap-6 relative px-8 py-12 md:px-10 md:py-16 transition-all duration-500">
                  ...
                  <div className="space-y-12">
                    ...
                    <div className="space-y-4">
                      ...
                      <p className="text-[15px] leading-[1.7] font-light text-white/50 transition-colors duration-500 group-hover:text-white/80">
                        Tokinvest&apos;s regulated platform ensures secure
                        transactions, immutable ownership records, and
                        integrated settlements — so every trade is safe, clear,
                        and straightforward.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-12">
                    ...
                    <div className="space-y-4">
                      ...
                      <p className="text-[15px] leading-[1.7] font-light text-white/50 transition-colors duration-500 group-hover:text-white/80">
                        ...
                        positions in real time — with ownership data, updates,
                        and key information always at your fingertips.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section id="faq" className="py-56 bg-background text-foreground">
          <div className="max-w-6xl mx-auto px-12 md:px-16 lg:px-20">
            ...
            <p className="text-[18px] leading-[1.7] font-light text-white/50 mb-24 max-w-xl">
              A considered guide to the essentials — how digital-syndication
              works, what it means for ownership, and where Evolution Stables
              fits in.
            </p>
