...
const faqItems = [
  {
    ...
    answer:
      'Evolution Stables is an institutional-grade marketplace designed for the acquisition and trade of digital equine assets. We provide a regulated, transparent environment for digital-syndication, ensuring that high-performance ownership is accessible to a global audience.',
  },
  {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="sr-only">
        ...
        <p>
          Evolution Stables is the premier platform for regulated racehorse ownership through
          digital-syndication and tokenised assets.
        </p>
      </div>
      <main className="text-foreground">
        <h1 className="sr-only">
          Evolution Stables - Regulated Marketplace for Digital Equine Assets
        </h1>
          ...
          <div className="max-w-6xl mx-auto px-12 md:px-16 lg:px-20 w-full">
            ...
            <div className="space-y-12 mb-16">
              ...
              <p className="text-[16px] leading-[1.7] font-light text-white/65">
                Evolution Stables professionalises the lifecycle of racehorse ownership, ensuring
                that market integrity and high-performance standards benefit all industry
                stakeholders.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <div className="relative space-y-4">
                  ...
                  <p className="text-[15px] leading-[1.9] font-light text-white/60">
                    Access premium thoroughbred syndications within a transparent, regulated
                    marketplace. Our platform ensures that risk, compliance, and asset performance
                    are clear before every commitment.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div className="relative space-y-4">
                  ...
                  <p className="text-[15px] leading-[1.9] font-light text-white/60">
                    Breeders and syndicators can leverage our institutional infrastructure to manage
                    digital equine assets, ensuring professional delivery and market-leading
                    transparency.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div className="relative space-y-4">
                  ...
                  <p className="text-[15px] leading-[1.9] font-light text-white/60">
                    Evolution Stables sets the standard for digital racing governance, converting
                    market participation into long-term stakeholder value and industry stability.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="grid gap-16 lg:grid-cols-[1fr,1fr] lg:gap-48 xl:gap-56">
              ...
              <div className="space-y-8">
                ...
                {/* Lead Paragraph */}
                <p className="text-[16px] leading-[1.7] font-light text-white/65">
                  Syndication has always been the heartbeat of racehorse ownership — sharing risk,
                  reward, and the thrill of the sport. But the way people participate has changed.
                </p>
                <p className="text-[16px] leading-[1.7] font-light text-white/65">
                  Our digital-syndication model builds on that legacy — lowering barriers,
                  increasing transparency, and unlocking new ways for owners, investors, and fans to
                  participate — without replacing what works.
                </p>
              </div>
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-[15px] leading-[1.6] font-light text-white/50 group-hover:text-white/70 transition-colors duration-500">
                          A digital platform that lowers barriers
                          <br />
                          and opens ownership to everyone.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="group py-2 transition-transform duration-500 hover:scale-[1.02]">
                    <div className="flex items-center gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-[15px] leading-[1.6] font-light text-white/50 group-hover:text-white/70 transition-colors duration-500">
                          Real-time performance, clear costs,
                          <br />
                  ...
                  <div className="group py-2 transition-transform duration-500 hover:scale-[1.02]">
                    <div className="flex items-center gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-[15px] leading-[1.6] font-light text-white/50 group-hover:text-white/70 transition-colors duration-500">
                          Fractional shares and short-term
                          <br />
                          commitments for modern investors.
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        <section id="innovation" className="py-56 bg-background text-foreground">
          <div className="max-w-6xl mx-auto px-12 md:px-16 lg:px-20">
            ...
            <h2 className="text-[36px] md:text-[48px] leading-[1.1] text-white font-light tracking-tight mb-6">
              Regulated Marketplace
              <br />
              for Digital Equine Assets
            </h2>

            {/* Description */}
            <p className="text-[16px] leading-[1.7] font-light text-white/65 mb-16 max-w-3xl">
              Behind our integrated marketplace, Tokinvest delivers the raw horsepower that powers
              digital-syndication — built on regulated, financial-grade infrastructure, tailored
              from institutional finance and adapted to meet the demands of modern equine asset
              management.
            </p>
            {/* Features */}
                  ...
                  <div className="space-y-12">
                    ...
                    <div className="space-y-4">
                      ...
                      <p className="text-[15px] leading-[1.7] font-light text-white/50 transition-colors duration-500 group-hover:text-white/80">
                        Explore available syndications and short-term leases — all clearly
                        structured, fully transparent, and ready to invest in with confidence.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group flex flex-col gap-6 relative px-8 py-12 md:px-10 md:py-16 transition-all duration-500">
                  ...
                  <div className="space-y-12">
                    ...
                    <div className="space-y-4">
                      ...
                      <p className="text-[15px] leading-[1.7] font-light text-white/50 transition-colors duration-500 group-hover:text-white/80">
                        Tokinvest&apos;s regulated platform ensures secure transactions, immutable
                        ownership records, and integrated settlements — so every trade is safe,
                ...
                <div className="group flex flex-col gap-6 relative px-8 py-12 md:px-10 md:py-16 transition-all duration-500">
                  ...
                  <div className="space-y-12">
                    ...
                    <div className="space-y-4">
                      ...
                      <p className="text-[15px] leading-[1.7] font-light text-white/50 transition-colors duration-500 group-hover:text-white/80">
                        Follow your horses, track performance, and manage your positions in real
                        time — with ownership data, updates, and key information always at your
                        fingertips.
                      </p>
                    </div>
                  </div>
        ...
        <section id="faq" className="py-56 bg-background text-foreground">
          <div className="max-w-6xl mx-auto px-12 md:px-16 lg:px-20">
            ...
            <p className="text-[18px] leading-[1.7] font-light text-white/50 mb-24 max-w-xl">
              A considered guide to the essentials — how digital-syndication works, what it means
              for ownership, and where Evolution Stables fits in.
            </p>
