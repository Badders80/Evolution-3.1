...
export const cardHoverEffects = {
  ...
  goldGradientShimmer: {
    gradient:
      'linear-gradient(140deg, rgba(255,255,255,0.06), rgba(212,169,100,0.08) 40%, transparent 70%)',
  ...
  pureWhiteShimmer: {
    gradient:
      'linear-gradient(140deg, rgba(255,255,255,0.06), rgba(255,255,255,0.10) 40%, transparent 70%)',
    badgeClasses: 'text-white/50 group-hover:scale-105 group-hover:text-white',
    transitionClasses: 'duration-700 ease-[cubic-bezier(0.16,1,0.3,1)]',
