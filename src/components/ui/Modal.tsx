  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center px-6 py-16 overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at center, #2a2a2a 0%, #1a1a1a 20%, #0a0a0a 40%, black 80%)',
          opacity: 1,
        }}
      />
      ...
      <div className="relative w-full max-w-sm z-10">
        <div className="relative group">
          ...
          <div
            className="absolute -inset-2 bg-neutral-900/80 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"
            style={{
              filter: 'blur(40px)',
              background:
                'radial-gradient(circle at center, rgba(38,38,38,0.6) 0%, rgba(0,0,0,0) 70%)',
            }}
          />
          ...
          <div className="relative bg-[#111111] border border-neutral-800/80 rounded-2xl p-8 shadow-2xl">
            <div className="mb-8 text-center">
              <h2 className="text-2xl font-medium tracking-wide text-neutral-100">{title}</h2>
